...
namespace ASPdotNetCore.Service
{
    public class AdminAreaAuthorizatlion : IControllerModelConvention
    {
        private readonly string area;
        private readonly string policy;

        public AdminAreaAuthorizatlion(string area, string policy)
        {
            this.area = area;
            this.policy = policy;
        }
